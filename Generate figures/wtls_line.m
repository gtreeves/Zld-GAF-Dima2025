...
% 2007-03-08
%
% Modified to not do global variables, Greg Reeves, 2013-03-23
...
[alphaopt,chiopt,exitflag] = ...
    fminbnd(@chialpha,alpha0-pi/2,alpha0+pi/2,optimset('TolX',tol),x,y,ux,uy);
...
% ------------------ subfunction to calc obj ftn --------------------------
function chi = chialpha(alpha,x,y,ux,uy)
%     global ux uy x y
uk2 = ux.^2*sin(alpha)^2 + uy.^2*cos(alpha)^2;
u2 = 1./mean(1./uk2);
w = u2./uk2;
